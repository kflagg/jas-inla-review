...
\item Wrote out discussion in \ref{conclusion}.
...
\textbf{Previous word count:} 5328 \hfill \textbf{Current word count:} 6872

\textbf{Previous page count:} 21.5 \hfill \textbf{Current page count:} 21
...
Suppose part of the study requires every observed
...
the sampled data (162 to 352) is much wider and shifted to the right compared
the interval when using the complete data (138 to 234). The reason for this is
