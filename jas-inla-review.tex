...
{\large\bf February 23, 2020}

\begin{itemize}

\item Simulated sampling \emph{bei} within rectangular windows and fit the model.

\item Created Baddeley et. al. (2005) residual plots (not included in manuscript).

\end{itemize}

\vfill

\textbf{Previous word count:} 3885 \hfill \textbf{Current word count:} 3895

\textbf{Previous page count:} 20.5 \hfill \textbf{Current page count:} 18.5
