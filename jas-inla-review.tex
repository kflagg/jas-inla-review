...
\begin{figure}[h]
\subfloat[Triangular mesh with pseudodata overlaid. Black dots represent
pseudodata with values of 0 at the mesh nodes. Red dots represent pseudodata
with values of 1 at the events.]
{\includegraphics[width=0.9\textwidth]{figures/bei_mesh.pdf}}

\subfloat[Piecewise linear approximation of the elevation surface.]
{\includegraphics[width=0.9\textwidth]{figures/bei_elev_mesh.pdf}}

\subfloat[Piecewise linear approximation of the gradient surface.]
{\includegraphics[width=0.9\textwidth]{figures/bei_grad_mesh.pdf}}

\caption{Data used with the Simpson and SPDE methods.}
\label{beimesh}
\end{figure}
...
list and the \texttt{inla()} function is called to fit the model. The
model takes about 90 seconds to fit on our laptop computer.

\begin{figure}[h]

\subfloat[Triangular mesh with observed region and events overlaid.]
{\includegraphics[width=0.9\textwidth]{figures/bei-effort_mesh.pdf}}

\subfloat[Piecewise linear approximation of the elevation surface.]
{\includegraphics[width=0.9\textwidth]{figures/bei-effort_elev_mesh.pdf}}

\subfloat[Piecewise linear approximation of the gradient surface.]
{\includegraphics[width=0.9\textwidth]{figures/bei-effort_grad_mesh.pdf}}
