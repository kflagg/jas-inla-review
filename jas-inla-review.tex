...
these methods include imputation of dummy points and often involve
discretization. In the world of maximum likelihood, perhaps the most
well-developed of these use approximations based on logistic regression on
presence/absence information in small disjoint regions {\it (cite a bunch of
Baddely etc papers)}.
...
Simpson et. al. explain that this is also computationally
