...
{\large\bf February 9, 2020}

\begin{itemize}

\item Proofread.

\item Incorporated many of Andy's comments.

\item Consolidated raw data figures into a single multipanel figure.

\item Added figures for a distance sampling example.

\end{itemize}

\vfill

\textbf{Previous word count:} 3257 \hfill \textbf{Current word count:} 3510

\textbf{Previous page count:} 13.5 \hfill \textbf{Current page count:} 20
...
{\it (insert paragraph giving overview of Cox process)}
...
{\includegraphics[width=0.9\textwidth]{figures/weeds.pdf}}

\subfloat[Indicator of sheep grazing, with events overlaid.]
{\includegraphics[width=0.9\textwidth]{figures/weedssheep.pdf}}
...
\begin{figure}[h]
\includegraphics[width=\textwidth]{figures/weedsmesh.pdf}
\caption{Triangular mesh with events overlaid.}
\label{weedsmesh}
\end{figure}

\begin{figure}[h]
\includegraphics[width=\textwidth]{figures/weedssheepmesh.pdf}
\caption{Piecewise linear approximation of the elevation surface.}
\label{weedssheepmesh}
\end{figure}

\begin{figure}[h]
\includegraphics[width=\textwidth]{figures/weedsdistmesh.pdf}
\caption{Piecewise linear approximation of the distance-to-transect surface.}
\label{weedsdistmesh}
\end{figure}

\begin{figure}[h]
\includegraphics[width=\textwidth]{figures/weedsbetas.pdf}
\caption{Posterior mean surface for the fixed effects.}
\label{weedsbetas}
\end{figure}

\begin{figure}[h]
\includegraphics[width=\textwidth]{figures/weedsmean.pdf}
\caption{Posterior mean of prediction surface.}
\label{weedsmean}
\end{figure}

\begin{figure}[h]
\includegraphics[width=\textwidth]{figures/weedssd.pdf}
\caption{Pointwise posterior standard deviation of predictions.}
\label{weedssd}
\end{figure}

\begin{figure}[h]
\includegraphics[width=\textwidth]{figures/weedsintensity.pdf}
\caption{Posterior intensity surface in events per square meter, calculated
using the piecewise linear approximate covariate surfaces and the posterior
means of the intercept, coefficients, and GP.}
...
\begin{figure}[h]
\includegraphics[width=\textwidth]{figures/weedsdetection.pdf}
\caption{Posterior detection probability over space.}
\label{weedsdetection}
\end{figure}

\begin{figure}[h]
\includegraphics[width=\textwidth]{figures/weedsresiduals.pdf}
\caption{Pearson residuals calculated on a grid.}
