...
INLA fast approximation for marginals useful for mapping
...
SPDE result approximates GP with CAR and sparse covariance matrix

\section{Going Off the Grid}

\setion{Variable Sampling Effort}
