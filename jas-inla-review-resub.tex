...
{\includegraphics[width=0.4\textwidth]{interp.pdf}}
...
\((1, 0, 0), (0, 1, 0), (0, 0, 1)\). ]
{\includegraphics[width=0.3\textwidth]{simplex.pdf}}
...
\begin{figure}[t!]\centering
\includegraphics[width=0.3\textwidth]{dual.pdf}
...
{\includegraphics[width=0.9\textwidth]{bei.pdf}}

\subfloat[Elevation in meters, with events overlaid.]
{\includegraphics[width=0.9\textwidth]{bei_elev.pdf}}

\subfloat[Magnitude of the elevation gradient, with events overlaid.]
{\includegraphics[width=0.9\textwidth]{bei_grad.pdf}}
...
\begin{figure}[t!]\centering
\includegraphics[width=\textwidth]{bei_mesh.pdf}
...
{\includegraphics[width=0.9\textwidth]{bei_betas.pdf}}

\subfloat[Posterior mean of the GP prediction surface.]
{\includegraphics[width=0.9\textwidth]{bei_mean.pdf}}
...
{\includegraphics[width=0.9\textwidth]{bei_intensity.pdf}}

\subfloat[Pearson residuals calculated on a grid.]
{\includegraphics[width=0.9\textwidth]{bei_residuals.pdf}}
...
{\includegraphics[width=0.9\textwidth]{bei-effort.pdf}}

\subfloat[Elevation in meters, with observed region and events overlaid.]
{\includegraphics[width=0.9\textwidth]{bei-effort_elev.pdf}}

\subfloat[Magnitude of the elevation gradient, with observed region and events
overlaid.]
{\includegraphics[width=0.9\textwidth]{bei-effort_grad.pdf}}
...
\begin{figure}[p!]
\includegraphics[width=\textwidth]{bei-effort_mesh.pdf}
...
\begin{figure}[p!]
\includegraphics[width=\textwidth]{bei-effort_partition.pdf}
...
\subfloat[Posterior mean surface for the fixed effects.]
{\includegraphics[width=0.9\textwidth]{bei-effort_betas.pdf}}

\subfloat[Posterior mean of the GP prediction surface.]
{\includegraphics[width=0.9\textwidth]{bei-effort_mean.pdf}}
...
using the piecewise linear approximate covariate surfaces and the posterior
means of the intercept, coefficients, and GP.]
{\includegraphics[width=0.9\textwidth]{bei-effort_intensity.pdf}}

\subfloat[Pearson residuals calculated on a grid.]
{\includegraphics[width=0.9\textwidth]{bei-effort_residuals.pdf}}
